  ...
  shell(
    ...
    <div style="display:flex;justify-content:space-between;align-items:center;flex-wrap:wrap;gap:12px;">
      ...
      <div style="display:flex;gap:8px;flex-wrap:wrap;">
        ...
        <button id="btn-export-pdf" class="btn ghost" style="padding:6px 10px;font-size:0.85rem;display:flex;align-items:center;gap:4px;width:auto;" title="Download PDF">
